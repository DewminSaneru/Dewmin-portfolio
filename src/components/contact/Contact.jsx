...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_fvkgwb4', 'template_wk2b04h', formRef.current, {
            publicKey: '7peEL5Wz8u2yjp2OT',
          })
          .then(
            (result) => {
              setSuccess(true);
    ...
    return(
        <motion.div ref={ref} className="contact" variants={varients} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={varients}>
                ...
                <motion.div className="item" variants={varients}>
                    <h2>Mail</h2>
                    <span>dewminsaneru.2001@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={varients}>
                    <h2>Address</h2>
                    <span>No: 112/H/17,</span><br/>
                    <span>Raja Samaranayake Mawatha,</span><br/>
                    <span>Alubomulla</span>
                </motion.div>
                <motion.div className="item" variants={varients}>
                    <h2>Phone</h2>
                    <span>+94 180 3513</span>
                </motion.div>
            </motion.div>
            <div className="formContainer">
                <motion.div className="phoneSvg" 
                    ...
                    >
                    <svg fill="#000000" height="450px" width="450px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.107 512.107" xml:space="preserve">
                        <g>
                            <g>
                                <motion.path 
                                    strokeWidth={1}
